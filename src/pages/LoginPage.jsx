        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="mt-12 flex items-center gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-emerald-200">Kg Food Saved</p>
            </div>
            <div className="w-px h-12 bg-emerald-400/30" />
            <div className="text-center">
              <p className="text-3xl font-bold">45+</p>
              <p className="text-sm text-emerald-200">Hunger Spots</p>
            </div>
            <div className="w-px h-12 bg-emerald-400/30" />
            <div className="text-center">
              <p className="text-3xl font-bold">156+</p>
              <p className="text-sm text-emerald-200">Deliveries</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
